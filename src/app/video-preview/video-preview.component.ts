    ...
    "test":[
      {
        "test_id":52,
        "test_name":"Epsisode1",
        "test_description":"The meeting and flashback ",
        "video_path":"http:\/\/www.djitsoft.xyz\/video_files\/test_6.mp4",
        "no_of_questions":1,
        "test_image":"http:\/\/www.mindshift.djitsoft.xyz\/assets\/images\/Poster 5.jpg",
...
// localStorage.setItem('Video_preview_current_test',  JSON.stringify(this.returnmsg1.test_id));

//keeps track of no of counts of test viewed
// if((JSON.parse(localStorage.getItem('Video_preview_testcount['+this.returnmsg1.test_id+']')))>0)
// {
//   this.test_count=JSON.parse(localStorage.getItem('Video_preview_testcount['+this.returnmsg1.test_id+']'))+1;
//   localStorage.setItem('Video_preview_testcount['+this.returnmsg1.test_id+']',  JSON.stringify(this.test_count));
// }
// else{
//   localStorage.setItem('Video_preview_testcount['+this.returnmsg1.test_id+']',  JSON.stringify(1));
// }
...
if(this.api.getDefaultMedia())
{
  ...
  if((JSON.parse( localStorage.getItem('Video_preview_lastpause['+this.returnmsg1.test_id+']')))>0)
  {
    if(Math.trunc(this.api.getDefaultMedia().currentTime)==0)
    {
      ...
      //       localStorage.setItem('Video_preview_lastpause['+this.returnmsg1.test_id+']',  JSON.stringify(0));
      //       console.log('local',(JSON.parse( localStorage.getItem('Video_preview_lastpause['+this.returnmsg1.test_id+']'))));
  ...
  // {
  // localStorage.setItem('Video_preview_lastpause['+this.returnmsg1.test_id+']',  JSON.stringify(this.ticks+1));
  // }
  ...
  if(this.j==this.z)
  {
    if(this.dis==0)
    {
      if(this.returnmsg1.stop_time==this.ticks)
      {
        ...
        this.api.getDefaultMedia().pause();
        // localStorage.setItem('Video_preview_replay',JSON.stringify(0));
        // localStorage.setItem('Video_preview_next_play',JSON.stringify(0));
        //   let dialogRef=this.dialog.open(ReportComponent, {
        //   disableClose:true,
        ...
        //     this.system_back=1;
        //     localStorage.setItem('Video_preview_next_play',JSON.stringify(0));
        //     localStorage.setItem('Video_preview_replay',JSON.stringify(this.returnmsg1.test_id));
        //     window.history.back();
        //   }
        ...
        //     this.system_back=1;
        //     localStorage.setItem('Video_preview_replay',JSON.stringify(0));
        //     localStorage.setItem('Video_preview_next_play',JSON.stringify(this.returnmsg1.next_test_id));
        //     window.history.back();
        //   }
